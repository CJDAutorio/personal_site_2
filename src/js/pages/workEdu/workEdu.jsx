        ...
        <Fade bottom duration={1250} delay={0} opposite cascade>
          <div className='flex-content-col'>
            <div className='subsection'>
              ...
              <div className='entry'>
                <h3 className='entry-title'>The University of North Carolina at Charlotte ⛏</h3>
                <div className='edu-flex'>
                  <p>Bachelor of Science in Computer Science</p>
                  <p>Concentration in Web & Mobile App Dev</p>
            ...
            <div className='subsection'>
              ...
              <div className='entry'>
                ...
                <p>
                  ...
                  Identity in their office in Denver, Colorado.<br />While at Ping, I was tasked with some
                  of the following:
                </p>
                <ul>
                  <li>
